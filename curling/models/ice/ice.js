...
const generateEnd = (dimensions, image) => {
  ...
  context.fillRect(
    x,
    y,
    dimensions.centerLineWidth,
    dimensions.hogLine - dimensions.hack
  );
  ...
  const bumpMap = new THREE.TextureLoader().load(
    "/samples-3d/curling/models/ice/ice-bump-02.png"
  );
  ...
  return new THREE.Mesh(
    new THREE.PlaneGeometry(dimensions.width, dimensions.hogLine, 32),
    material
  );
};
...
const generateHogToHog = (dimensions, image) => {
  ...
  return new THREE.Mesh(
    new THREE.PlaneGeometry(dimensions.width, dimensions.hogToHog, 32),
    material
  );
};
  ...
  static generate(dimensions) {
    return new Promise((resolve) => {
      ...
      image.onload = () => {
        ...
        far.position.y =
          dimensions.hogLine / 2 + dimensions.hogToHog + dimensions.hogLine;
